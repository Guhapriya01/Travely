...
<body style="margin: 0px">
	...
	<div id="Tab1" class="tabcontent">
		<object type="text/html" data="flight/addflight.html"
			style="width: 100%; height: 730px;"></object>
	</div>

	<div id="Tab2" class="tabcontent">
		<object type="text/html" data="flight/updateflight.html"
			style="width: 100%; height: 100%;"></object>
	</div>

	<div id="Tab3" class="tabcontent">
		<object type="text/html" data="flight/deleteflight.html"
			style="width: 100%; height: 100%;"></object>
	</div>
